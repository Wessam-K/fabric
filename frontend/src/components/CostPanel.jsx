export default function CostPanel({ cost, masnaiya, masrouf, marginPct, consumerPrice, wholesalePrice, onChangeMasnaiya, onChangeMasrouf, onChangeMargin, onChangeConsumer, onChangeWholesale }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-gray-50 rounded-xl p-4 space-y-2 text-sm">
        ...
        <div className="flex justify-between"><span className="text-gray-500">المصنعية:</span><span className="font-mono">{fmt(cost.masnaiya)} ج</span></div>
        <div className="flex justify-between"><span className="text-gray-500">المصروف:</span><span className="font-mono">{fmt(cost.masrouf)} ج</span></div>
