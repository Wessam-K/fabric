...
const NAV_GROUPS = (can, user) => [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/accounting/income-statement', label: '\u0642\u0627\u0626\u0645\u0629 \u0627\u0644\u062f\u062e\u0644', icon: BarChart2, hide: () => !can('accounting', 'view') },
      { path: '/accounting/balance-sheet', label: '\u0627\u0644\u0645\u064a\u0632\u0627\u0646\u064a\u0629 \u0627\u0644\u0639\u0645\u0648\u0645\u064a\u0629', icon: BarChart2, hide: () => !can('accounting', 'view') },
      { path: '/accounting/cash-flow', label: '\u0627\u0644\u062a\u062f\u0641\u0642\u0627\u062a \u0627\u0644\u0646\u0642\u062f\u064a\u0629', icon: BarChart2, hide: () => !can('accounting', 'view') },
