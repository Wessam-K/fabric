...
const PivotTable = lazy(() => import('./reports/PivotTable'));
    ...
    <div className="page">
      ...
      {loading ? (
        ...
        <>
          ...
          {tab === 'pivot' && <Suspense fallback={<div className="flex justify-center py-12"><div className="animate-spin h-8 w-8 border-4 border-[#c9a84c] border-t-transparent rounded-full" /></div>}><PivotTable /></Suspense>}
        </>
      )}
    </div>
  );
